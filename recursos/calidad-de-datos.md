...
------------ | ------------- | -------------
[OpenRefine](https://openrefine.org/){:target="_blank"} | Estructuración, estandarización y validación | Permite limpiar, transformar y dar formato a los datos, usar servicios web, corrección masiva campos, entre muchas otras. [Formación - Uso básico](/formacion/laboratorios/OpenRefine){: .button .is-small}
[Formación - Rutinas](/formacion/laboratorios/RutinasOpenRefine){: .button .is-small} |
