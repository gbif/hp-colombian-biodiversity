...
|[Glosario de sistemas de información geográfica – SIG.](https://www.proteccioncivil.org/catalogo/carpeta02/carpeta24/vademecum12/vdm02526.htm)|Presenta definiciones cortas de diferentes términos. Se recomienda revisar términos alusivos a la georreferenciación y SIG :  Datum, referencia espacial, base de datos geográficos, datum, capa, centroide, elevación, entidad, exactitud, precisión, geoide, georreferenciar, GPS, Latitud, longitud, mapa, plano, orientación, proyección de coordenadas, proyección de mapa.|
|[Tutorial 1: Instalación y principales opciones de QGIS.](http://youtu.be/FPnU-74TLDw)|Explica la instalación, descripción de ntorno geográfico y opciones de toolbars|
