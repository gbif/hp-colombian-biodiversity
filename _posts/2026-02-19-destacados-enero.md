---
preTitle: 19 de febrero, 2026
title: "El 2026 arranca con fuerza: nuevos publicadores, nuevas especies y colecciones fortalecidas"
description: "_De una reserva en el Pacífico a los cultivos de Ocaña: los datos que ampliaron el mapa este mes_"
date: 2026-02-19
categories: ["Publicación", "Datos abiertos", "enero", "Destacados SiB", "2026"]
background: /assets/images/noticias_eventos/2026/2026-02-19-destacados_enero.png
...
*[Consulta la guía para publicar datos en el SiB Colombia](https://biodiversidad.co/compartir/guia-para-publicar/)*

Desde el equipo coordinador del SiB Colombia acompañamos mes a mes este proceso, destacando los aportes más relevantes por su impacto en el conocimiento, la gestión y la conservación de la biodiversidad. Estos son los avances de enero de 2026.
...
Los escarabajos colombianos tienen ahora una referencia más completa. Coleoptera de Colombia **amplió su lista de especies** con cuatro nuevas incorporaciones, fortaleciendo el inventario de uno de los grupos de insectos más diversos del planeta y aportando información clave para estudios taxonómicos y de conservación en el país.

*[Consulta la lista de Coleoptera de Colombia ](https://biodiversidad.co/dataset/129b339c-4c13-480a-bfc7-c00c2b5c5712)*

*Eventos de muestreo*

En el corazón de Cartagena, los polinizadores también tienen su historia. [El Jardín Botánico de Cartagena ‘Guillermo Piñeres’ ](https://jbgp.org.co/)compartió los resultados de un ejercicio de monitoreo que registró **88 observaciones a lo largo de 63 eventos de muestreo**, documentando la diversidad de polinizadores presentes en sus instalaciones. Estos datos abren una ventana al papel que juegan estos organismos en los ecosistemas urbanos y su relación con la flora del jardín.

*[Conoce los eventos de muestreo de polinizadores del Jardín Botánico de Cartagena](https://biodiversidad.co/data?datasetKey=156258a2-ea0f-4cd1-98a7-6df4c245c94a) [ ](https://biodiversidad.co/data?datasetKey=156258a2-ea0f-4cd1-98a7-6df4c245c94a)*

*Registros biológicos*

La biodiversidad no solo vive en los bosques. [La Corporación Colombiana de Investigación Agropecuaria (AGROSAVIA)](https://www.agrosavia.co/) publicó registros sobre la diversidad de **artrópodos y microorganismos presentes en cultivos de cebolla de bulbo** en la provincia de Ocaña, Norte de Santander. Un conjunto de datos que pone en valor la agrobiodiversidad y su importancia para entender cómo la naturaleza interactúa con los sistemas productivos del país.
