...
---
 <details>
  <summary markdown="span"><B>¿Existe la posibilidad que los datos se conserven confidenciales?</B></summary>
...
<br>
Puedes consultar las extensiones a través de la siguiente <a href="https://tools.gbif.org/dwca-validator/extensions.do" target="_blank">enlace</a>. Se debe revisar que la extensión aplique al tipo de datos que quieras publicar.
...
<details>
  <summary markdown="span"><B> Si se cuuenta con el código de la colección, pero aún no se ha asignado número del catálogo, ¿Es posible diligenciar la columna Código de la colección y dejar la casilla Número de catálogo vacía?</B></summary>
...
Sí. Para esto se se debe evaluar el estándar con el cual se elaboraron esas fichas y su compatibilidad con el estándar Plinian Core. Si está interesado en esto, debe escribir un correo a <a href="mailto:sib@humboldt.org.co">sib@humboldt.org.co</a> explicando a dedtalle el caso de la fihca particlar.
<br>
    </details>
...
## Artículos de datos
 ...
 <details>
  <summary markdown="span"><B>¿Qué elementos diferenciales se esperaan entre la primera publicación científica y el artículo de datos?</B></summary>
    
<br>
Lla primera publicación (el artículo científico tradicional) se hace bajo el método científico y resuelve una pregunta de investigación puntual, mientras que el artículo de datos describe sistemáticamente un conjunto de datos.
...
<br>
Si, todas las revistas de artículos de datos solicitan que los datos ya estén publicados para poder publicar el artículo de datos.
...
---
 ...
 <details>
  <summary markdown="span"><B>¿Cuál es la recomendación para establecer la autoría de un conjunto de datos y de los artículos y como se diferencian las personas de las instituciones en la autoría? </B></summary>
    
<br>
Las autorías, tanto de los conjuntos de datos como sus artículos derivados, corresponden a personas con determinadas afiliaciones institucionales. La práctica adecuada es poner desde el principio el nombre de la persona (como en el modelo de publicación académico). La instituciones siguen siendo visibles en todas las instancias de publicación. Anteriormente se aceptaban auditorias institucionales pero es una práctica que ya no está vigente.
...
<br>
El SiB Colombia facilita la publicación de datos asociados a permisos de recolección de acuerdo a la normativa ambiental. En este caso, la publicación ocurre bajo un proceso de autogestión que no involucra un acompañamiento directo el Equipo Coordinador. 
...
<br>
En este <a href="http://repository.humboldt.org.co/handle/20.500.11761/35329"target="_blank">enlace</a> se describe el modelo de ventanas regionales con el objetivo de incluir el enfoque regional en las publicaciones
...
---
 <details>
  <summary markdown="span"><B>¿Es posible registrar ausencias en los registros?</B></summary>
    
<br>
    Sí. Para el registro de ausencias el estándar Darwin Core cuenta con el elemento (<i>ioccurrenceStatus</i>) donde se puede documentar el registro como una Presencia o Ausencia según sea el caso. Para mayor detalle se recomienda ver el seminario sobre los estándares de publicación en el siguiente <a href="https://www.youtube.com/watch?v=nYGu8KY_K6U&t=3s " target="_blank">enlace</a>.
...
<br>
    Sí, es posible. Se recomienda usar los elementos <i>organismQuantity</i>, <i>organismQuantity</i> y <i>organismQuantityType</i> del estándar Darwin Core. La definición y uso de estos elementos se encuentran en la sección  3.5 de la siguiente <a href="https://sites.google.com/humboldt.org.co/wikisib/publicar/plantillas?authuser=0 " target="_blank">plantilla de publicación </a> 
...
<br>
No es necesario crear un nuevo usuario; sin embargo, se debe asociar dicho usuario a la administración de los recursos de la nueva organización para que pueda acceder y editar los metadatos. Para lograr esto envíe un correo a <a href="mailto:sib@humboldt.org.co">sib@humboldt.org.co</a> solicitando el apoyo perinente.
...
---
 ...
 <details>
  <summary markdown="span"><B>¿En el buscador del SiB se enlaan las sinonimias de cada especie?</B></summary>
...
<br>
Se puede tpomar este dato en el momento de la salida mediante GPS (es mportante que esté configurado y se conozca el sistema de referencia al momento de tomar las coordenadas) o posteriormente usando un Modelo Digital de Elevación como el SRTM y las coordenadas de cada registro.
...
<br>
En los datos originales no se encuentran diferencias. Sin embargo, en los datos interpretados sí pueden haber diferencias ya que GBIF homologa todos los taxa a su árbol taxonómico para optimizar la consulta ybúsqueda de los datos.
...
Estos dos links se pueden encontrar herramientas útiles solicitadas:
<ul>
...
<ul>
    ...
    <li>En scientificName hacer el registro de esta manera: Leptospira weilii serovar Celledoni; es decir, se debe incluir infraSubspecificRank en el nombre</li></ul>
<br>
    </details>
