...
<br>
Para registrar su organización en el SiB Colombia y comenzar un proceso de publicación diligencie el siguiente <a href="/compartir/registrarse">formulario</a>. La información registrada aquí nos permitirá contar con información básica sobre su organización y el tipo de datos a publicar. Una vez validemos la información consignada, enviaremos las credenciales para ingresar a la plataforma de publicación. Una entidad puede tener tantos usuarios como sea necesario para la adecuada gestión de sus datos. Si tiene dudas sobre el proceso comuníquese directamente a sib@humboldt.org.co.
    </details>
...
<details>
    <summary markdown="span"><b>¿Cómofichas actualizar la información de la organización?</b></summary>
...
Para la publicación de registros biológicos debes tener en cuenta que pueden corresponder a observaciones o registros asociados a colecciones biológicas. En la <a href="/recursos/plantillasdwc#registros-biológicos">plantilla de publicación</a> de registros biológicos podrás ver los elementos obligatorios según el tipo de publicación.  
</details>

---
 <details>
  <summary markdown="span"><B>¿Existe la posibilidad de que los datos se conserven como confidenciales?</B></summary>
    
<br>
No, la publicación se debería realizar solo cuando los datos puedan ser de acceso abierto.
...
## Extensiones
 ...
 <details>
  <summary markdown="span"><B>¿En dónde puedo revisar las extensiones epecíficas?</B></summary>
    
<br>
Se pueden consultar las extensiones en el siguiente <a href="https://tools.gbif.org/dwca-validator/extensions.do" target="_blank">enlace</a>. Se debe revisar que la extensión aplique al tipo de datos que se desee publicar.
...
___
 ...
 <details>
  <summary markdown="span"><B>¿Cómo se indica que se está registrando una nueva especie?</B></summary>
    
<br>
Se debe especificar el "sp. nov" en el elemento verbatimTaxonRank y en el nombre científico documentar el género.
...
___
 ...
 <details>
  <summary markdown="span"><B>¿El Estándar Darwin Core permite trabajar con coordenadas geográficas en lugar de coordenadas decimales?</B></summary>
    
<br>
Se pueden incluir coordenadas geográficas y decimales. Las coordenadas geográficas se pueden documentar como coordenadas originales (elemento verbatimCoordinates del DwC). Las coordenadas decimales son requeridas y para esto se pueden convertir las coordenadas originales (en grados, minutos y segundos) a coordenadas decimales; estas se deben documentar en los elemento decimalLatitude y decimalLongitude del DwC. En la <a href="https://sib-colombia.github.io/Formacion/LAB/lab02/lab_convertCoord.html  " target="_blank">página de laboratorios</a> se puede ver la herramienta de conversión de coordenadas. 
...
---
 ...
 <details>
  <summary markdown="span"><B>¿Cuál es el sistema de coordenadas que se debe usar?</B></summary>
    
<br>
El sistema de referencia espacial recomendado es el WGS84 (World Geodetic System 1984).
<br>
    </details>
...
---
 ...
 <details>l
  <summary markdown="span"><B>¿Los sistemas WGS84 y MAGNA - SIRGAS son equivalentes para Colombia?</B></summary>
    
<br>
Si, son equivalentes pues usan el mismo elipsoide de referencia. Según la documentación del IGAC: "... para nuestro país se tiene que  MAGNA-SIRGAS tiene asociado un elipsoide llamado Global Reference System 1980 (GRS80, por sus siglas en Inglés), que se considera equivalente al elipsoide World Geodetic System 1984 (WGS84, por sus siglas en Inglés), el cual es el aceptado internacionalmente como Datum de Referencia Global". Para mas información te invitamos a revisar este <a href="https://www.igac.gov.co/es/contenido/areas-estrategicas/informacion-geodesica" target="_blank">enlace</a>.  
...
---
 ...
 <details>
  <summary markdown="span"><B>Si no se realizó la adecuada calibración del GPS previamente a la toma de las coordenadas, ¿Se debe descartar el registro?</B></summary>
    
<br>
No, no se debe descartar de manera inmediata el registro. En ese caso habría que revisar las especificaciones de calibración o configuraicones del GPS para ver si es posible hacer alguna transformación que permita ajustar la proyección de los datos. 
...
___
 ...
 <details>
  <summary markdown="span"><B>¿Cómo se deben registrar las posibles abreviaturas de ciertos ejemplares de colecciones?</B></summary>
    
<br>
Algunas etiquetas de colecciones contienen abreviaturas (por ejemplo, registra Fca., Vda., Cgto. para Finca, Vereda y Corregimiento, respectivamente). Lo recomemdable en estos casos es documentar en el elemento verbatimLocality como está literalmente en la etiqueta y en locality completar la información sin abreviaturas y especificando siempre el tipo de entidad o accidente geográfico (Corregimiento, Vereda, Río, etc.)
...
## Calidad de datos
 ...
 <details>
  <summary markdown="span"><B>¿Cuáles son las mejores prácticas para registrar serotipos de bacterias?</B></summary>
    
<br>

<ul>
    <li>Se recomienda indicar Serovar en taxonRank (no únicamente en verbatimTaxonRank).</li>
    <li>En scientificName hacer el registro de esta manera: Leptospira weilii serovar Celledoni; es decir, se debe incluir infraSubspecificRank en el nombre</li>
    <li>Generalmente, la columna del taxón de GBIF no reconoce el serotipo y asignará una categoría taxonómica superior a la especie o el género; sin embargo, es posible buscar por el nombre provisto (verbatim) del taxon. <a href="https://www.gbif.org/occurrence/search?q=serovar&advanced=1&verbatim_scientific_name=Leptospira%20weilii%20serovar%20Celledoni&occurrence_status=present" target="_blank">Ver ejemplo</a>. </li>
    <li>Además de indicar el seotipo en scientificName, es recomendable especificarlo en infraspecificEpithet. </li>
    </ul>
<br>
    </details>
...
---
 ...
 <details>
  <summary markdown="span"><B>¿Cómo se recomienda tomar el dato de altura?</B></summary>
    
<br>
Se puede tpomar este dato en el momento de la salida mediante GPS (es importante que esté correctamente configurado y se conozca el sistema de referencia al momento de tomar las coordenadas) o posteriormente usando un Modelo Digital de Elevación como el SRTM y las coordenadas de cada registro.
...
---
 ...
 <details>
  <summary markdown="span"><B>¿Hay alguna recomendación para usar taxonomías superiores de manera estandarizada?</B></summary>
    
<br>
Existen muchas fuentes para corroborar la taxonomía superior o validar los nombres científicos documentados, esto depende del grupo biológico particular y del criterio del taxónomo que realiza las identificaciones. En todo caso, se recomienda usar referentes taxonómicos propios de cada grupo (tales como FishBase en el caso de peces, IndexFungorum para el reinpo fungi y Iplant para plantas); sin embargo, ningún referente es perfecto y normalmente hay falencias a nivel de especies endémicas. El backbone de GBIF comprende muchos de estos referentes especializados. También se recomienda usar listas de referencia locales o usar bases generales como Global Name Resolver, que integra varias fuentes taxonómicas.
...
---
 ...
 <details>
  <summary markdown="span"><B>¿Cómo se registran los campos de ubicación geográfica de tipo punto?</B></summary>
...
<ul>
    <li>Documentar en los elementos decimalLatitude y decimalLongitude las coordenadas del inicio del transecto y el elemento footprintWKT con las coordenadas iniciales y finales del mismo. Ejemplo: LINESTRING (2.80151 51.28597, 2.61749 51.53950) donde se indica la geometría (LINESTRING=transecto, POLYGON=parcela) seguido de las coordenadas de cada punto del área de muestreo ( dos pares de coordenadas para transectos; mínimo cuatro pares de coordenadas para parcelas).</li>

<li>Documentar en los elementos decimalLatitude y decimalLongitude las coordenadas del punto medio del transecto ,  junto con el elemento coordinateUncertaintyInMeters, donde se documenta la incertidumbre de la coordenada que corresponderá a la distancia en metros entre el punto medio del transecto y el punto inicial o final. Adicionalmente se puede documentar el elemento footpirntWKT como se indica en el punto 1.</li>
</ul>
...
<details>
  <summary markdown="span"><B>¿En necesario registrar los datos hasta la categoría taxonómica de especie?</B></summary>
    
<br>
No es necesario, se puede registrar cualquier catergoría superior (inclusio reino).
...
___
 ...
 <details>
  <summary markdown="span"><B>¿Qué licencia debo asignar a mi recurso?</B></summary>
...
<br>
Si usaste los datos de un recurso publicado a través del SiB Colombia, puedes citar buscando la sección <b>¿Cómo referenciar?</b> en los metadatos del recurso, ahí encontrarás la cita según lo definió el publicador de los datos. La recomendación es siempre incluir el DOI del recurso en la citación. Ejemplo:<br>

Recurso: Tití Gris (Saguinus leucopus) en remanentes de bosque de los departamentos de Caldas y Antioquia<br>
...
<ul>
 ...
 <details>
  <summary markdown="span"><B>¿Se pueden consultar públicamente  los datos obtenidos por permisos de recolección?</B></summary>
    
<br>
Los datos asociados a permisos de recolección son publicos y se encuentran dispobibles en este <a href="https://ipt.biodiversidad.co/cr-sib/" target="_blank">enlace</a>, sin embargo, estos no son tenidos en cuenta para la síntesis de cifras nacionales, y no son visibles a través de los canales de participación como el portal de datos y a nivel internacional en GBIF. Las entidades interesadas en hacer visibles los datos asociados a permisos de recolección, sólo deben hacer la solicitud de un acompañamiento a través del correo <a href="mailto:sib@humboldt.org.co">sib@humboldt.org.co</a>  manifestando su voluntad de publicar la información a través de este modelo. Desde el Equipo Coordinador se garantizará que los datos sean visibles en las instancias de consulta de la autoridad ambiental para el cumplimiento de las obligaciones del permiso
...
<details>
  <summary markdown="span"><B>¿Cómo es la visibilidad de los datos de especies en en categorías de amenaza, peligro y peligro crítico?</B></summary>
    
<br>
El estándar Darwin Core cuenta con unos elementos que permiten la generalización de las coordenadas para no disponer la ubicación específica de estas especies y evitar exponerlas a un peligro mayor. Sin embargo, esto debe ser especificado por el publicador al momento de hacer la publicación a través del SiB Colombia.
...
<br>
Sí, se puede agregar, corregir o eliminar información a nivel de datos y metadatos las veces que sea necesario. El IPT se encargará de versionar los cambios realizados en el recurso. El proceso es similar al de publicación, ya que involucra la carga de un nuevo archivo con la versión más reciente de los datos y la edición de metadatos. 

Si el publicador cuenta con credenciales del SiB Colombia en el IPT, puede acceder al recurso y realizar los cambios, al final debe notificar al SiB Colombia sobre la actualización para proceder con la publicación.
   </details>
...
---
 <details>
  <summary markdown="span"><B>¿Se pueden vincular fichas de especies de portales independientes (ONG, empresas, centros de investigación) con el del SIB?</B></summary>
    
<br>

Sí. Para esto se se debe evaluar el estándar con el cual se elaboraron esas fichas y su compatibilidad con el estándar Plinian Core. Si está interesado en esto, debe escribir un correo a <a href="mailto:sib@humboldt.org.co">sib@humboldt.org.co</a> explicando a detalle las características de la ficha particlar.
<br>
    </details>
...
---
 ...
 <details>
  <summary markdown="span"><B>¿Las fichas de especies están ligadas a las fichas de especies de Biomodelos?</B></summary>
    
<br>
Actualmente no están conectados; sin embargo, el alcance de Biomodelos es facilitar modelos de distribución y no fichas de especies. Las fichas de especie publicadas a través del SiB Colombia bajo el estándar plinian Core cuentan con información de la biología, distribución, estado de amenaza, etc. obtenidos principalmente a partir de información secundaria.
...
<details>
  <summary markdown="span"><B>¿Cómo puedo obtener el certificado de reporte a través del SiB Colombia de los especímenes derivados de ufn permiso de colecta?</B></summary>
...
## Artículos de datos
 ...
 <details>
  <summary markdown="span"><B>¿Qué elementos diferenciales se esperan entre la primera publicación científica y el artículo de datos?</B></summary>
    
<br>
La primera publicación (el artículo científico tradicional) se hace bajo el método científico y resuelve una pregunta de investigación puntual, mientras que el artículo de datos describe sistemáticamente un conjunto de datos.
...
---
 ...
 <details>
  <summary markdown="span"><B>¿Todos los datos se deben publicar por el SIB antes de publicar el artículo de datos?</B></summary>
    
<br>
Sí, todas las revistas de artículos de datos solicitan que los datos ya estén publicados para poder publicar el artículo de datos.
...
---
 ...
 <details>
  <summary markdown="span"><B>¿Cuál es la recomendación para establecer la autoría de datos, de los artículos de datos? y ¿cómo se diferencian las personas de las instituciones en la autoría? </B></summary>
    
<br>
Las autorías, tanto de los conjuntos de datos como sus artículos derivados, corresponden a personas con determinadas afiliaciones institucionales. La práctica adecuada es poner desde el principio el nombre de la persona (igual que en el modelo de publicación académico). La instituciones siguen siendo visibles en todas las instancias de publicación. Anteriormente se aceptaban auditorias institucionales pero es una práctica que ya no está vigente.
...
---
 ...
 <details>
  <summary markdown="span"><B>Después de la publicación de un artículo de datos, ¿hay  restricciones sobre la manipulación de los mismos?</B></summary>
    
<br>
Desde el punto de vista del autor, no; quien los publica sigue teniendo completo control de sus datos independientemente del artículo. Desde el punto de vista del uso, la publicación de los datos está asociada a una licencia creative commons que define de manera explícita cómo usar los datos, más que restringirlos define la mejor manera de utilizarlos según lo haya establecido el publicador.
...
---
 ...
 <details>
  <summary markdown="span"><B>¿Debe haber una cantidad mínima de datos y de análisis para publicar un artículo de datos </B></summary>
    
<br>
No hay un mínimo, depende en gran medida de cada grupo biológico y las restricciones taxonómicas y geográficas en cada caso.
...
---
 ...
 <details>
  <summary markdown="span"><B>¿Cómo se enlazan los datos de un artículo de datos de una revista extranjera con el SIB?</B></summary>
    
<br>
Por medio del DOI del conjunto de datos. En el artículo de datos se debe citar el DOI de los datos para que pueda ser rastreado.
...
<details>
  <summary markdown="span"><B>¿Qué revistas son recomendadas para publicar el articulo de datos?</B></summary>
    
<br>
En la siguiente <a href="https://www.gbif.org/data-papers  " target="_blank">página</a> hay una lista de revistas donde pueden publicarse artículos de datos. A nivel nacional se cuenta con la revista Biota Colombiana que publica artículos en español. Para mas información puede visitar este <a href="http://revistas.humboldt.org.co/index.php/biota" target="_blank">enlace</a>. 
...
## Otras
 ...
 <details>
  <summary markdown="span"><B>¿Las publicaciones en el SiB Colombia tienen un impacto positivo en la clasificación de grupos de Minciencias?</B></summary>
    
<br>
Sí, en esta <a href="https://biodiversidad.co/post/2021/convocatoria-nacional-medicion-grupos-cvlac-sib/">entrada</a> de nuestro blog se encuentran los detalles asociados a la convocatoria 2021. 
<br>
    </details>
...
___
 ...
 <details>
  <summary markdown="span"><B>¿Es obligatorio solicitar el acompañamiento al publicar datos?</B></summary>
    
<br>
Si se trata de una publicación de datos por permiso de recolección no se realiza acompañamiento por parte del Equipo Coordinador; en caso de que la publicación sea voluntaria, no es obligatorio solicitar este acompañamiento, aunque es muy recomendable hacerlo para asegurarse de que los datos cumplan los criterios de calidad y completitud mínimos requeridos.
<br>
    </details>
...
---
 ...
 <details>
  <summary markdown="span"><B>¿Se pueden publicar datos obtenidos en trabajos de consultorías?</B></summary>
    
<br>
Sí. El SiB Colombia facilita la publicación de datos asociados a permisos de recolección de acuerdo a la normativa ambiental. En este caso, la publicación ocurre bajo un proceso de autogestión que no involucra un acompañamiento directo el Equipo Coordinador. 
...
---
 ...
 <details>
  <summary markdown="span"><B>¿Una publicación puede contar con más de una organización autora?</B></summary>
    
<br>
Sí. Es necesario reconocer a todas las organizaciones cuyo trabajo es conducente a una publicación. Este reconocimiento hace parte de los metadatos del recurso.
...
---
 <details>
  <summary markdown="span"><B>¿Existe algún modelo de publicación con enfoque regional?</B></summary>
    
<br>
    
En este <a href="http://repository.humboldt.org.co/handle/20.500.11761/35329" target="_blank">enlace</a> se describe el modelo de ventanas regionales cuyo objetivo es el enfoque regional en las publicaciones.
...
---
 ...
 <details>
  <summary markdown="span"><B>¿Es posible consultar directamente los datos por cada jurisdicción de las CAR en relación a especies endémicas y amenazadas?</B></summary>
    
<br>
Esta búsqueda no se puede realizar de manera directa a través de nuestros portales. Es necesario buscar los conjuntos de datos publicados por la CAR de interés o descargar todos los datos de los departamentos y/o municipios bajo la jurisdicción de la CAR.
La lista de especies amenazadas del país  se encuentra <a href="https://doi.org/10.15472/5an5tz" target="_blank">aquí</a>.
...
---
 ...
 <details>
  <summary markdown="span"><B>¿Dónde se puede encontrar información sobre el número de especies de los grupos biológicos principales?</B></summary>
    
<br>
Esta información está disponible a través a través del portal <a href="https://cifras.biodiversidad.co">Biodiversidad en cifras</a>.
...
---
 ...
 <details>
  <summary markdown="span"><B>¿Dónde se puede encontrar información sobre las listas de especies?</B></summary>
    
<br>
Esta información está disponible a través a través del portal <a href="https://listas.biodiversidad.co">Listas de especies</a>.
...
---
 <details>
  <summary markdown="span"><B>¿Los primeros registros de una especie se deben publicar primero en el portal del SIB o en el manuscrito científico?</B></summary>
    
<br>
Se pueden publicar los datos a través del SiB Colombia y citar los registros en el manuscrito. Si se trata de nuevas especies, se pueden publicar a un nivel de identificación superior (como género) y una vez sea aprobado el manuscrito puedes actualizar la publicación incluyendo el nombre de la especie.
...
---
 <details>
  <summary markdown="span"><B>¿Es posible registrar ausencias en las publicaciones?</B></summary>
    
<br>
    Sí. Para el registro de ausencias el estándar Darwin Core cuenta con el elemento ioccurrenceStatus, donde se puede documentar el registro como una Presencia o Ausencia según sea el caso. Para mayor detalle se recomienda ver el seminario sobre los estándares de publicación en el siguiente <a href="https://www.youtube.com/watch?v=nYGu8KY_K6U&t=3s " target="_blank">enlace</a>.
...
---
 <details>
  <summary markdown="span"><B>¿Se puede reportar la cuantificación de organismos de comunidades hidrobiológicos con individuos/litros?</B></summary>
    
<br>
    Sí, es posible. Se recomienda usar los elementos organismQuantity, organismQuantity y organismQuantityType del Estándar Darwin Core. La definición y uso de estos elementos se encuentran en la sección  3.5 de la siguiente <a href="https://sites.google.com/humboldt.org.co/wikisib/publicar/plantillas?authuser=0 " target="_blank">plantilla de publicación </a> 
...
---
 <details>
  <summary markdown="span"><B>¿Se pueden publicar registros provenientes de ADN ambiental o metagenómica?</B></summary>
    
<br>
Sí. Se publican como cualquier registro biológico (o evento de muestreo, en el caso de estudos metagenómicos) con la particularidad de que la evidencia de la presencia del organismo proviene de ADN ambiental. En este caso la base del registro se documenta como MaterialSample, en el protocolo de muestreo se especifica que la evidencia es ADN ambiental y se puede incluir un enlace a la información genética dispuesta en los repositorios específicos para ello.
<br>
    </details>
...
---
 <details>
  <summary markdown="span"><B>Si se hace más de una publicación con un ejemplar de una colección, ¿habría doble registro?</B></summary>
    
<br>

Se puede llegar a interpretar como una duplicación, aunque hay varias estrategias para evitarlo o detectarlo por parte de los usuarios. Una es la base del registro, otra son los ID asociados a los datos y finalmente tenemos variables como fechas, colector, números de catálogo, etc. En ese orden de ideas los duplicados no generan ninguna limitación y son válidos debido a que cada dato podría tener una historia diferente a través del tiempo.
...
___
 ...
 <details>
  <summary markdown="span"> <B>En el caso de especies marinas, ¿El registro se hace a través del INVEMAR o con el SiB Colombia?</B></summary>
    
<br>
Ya que el SiB Colombia y el SiB Marino (INVEMAR) utilizan el mismo modelo de publicación de datos, la publicación se puede realizar contactando con cualquiera de los dos sistemas y con un mismo esfuerzo los datos quedarán al mismo tiempo en ambas instancias.
...
---
 ...
 <details>
  <summary markdown="span"><B>¿Es posible publicar datos netamente geográficos (como shapes o gdb) o abióticos que en algunos casos complementan los informes y estudios biológicos?</B></summary>
    
<br>
Actualmente a través del SiB Colombia y bajo el estándar Darwin Core no es posible publicar bases de datos geográficas de forma directa o relacionar capas geográficas complejas de forma directa en los datos. Sin embargo, si existen bases de datos o capas almacenadas en repositorios web, estos pueden ser relacionados en los metadatos de la publicación.
...
---
 ...
 <details>
  <summary markdown="span"><B>¿Qué pasa con el usuario de una persona que cambia de organización poblicadora asociada?</B></summary>
    
<br>
No es necesario crear un nuevo usuario; sin embargo, se debe asociar el usuario a la administración de los recursos de la nueva organización para que pueda acceder y editar los metadatos. Para esto envíe un correo a <a href="mailto:sib@humboldt.org.co">sib@humboldt.org.co</a> solicitando el apoyo perinente.
...
---
 ...
 <details>
  <summary markdown="span"><B>¿Los registros en el Sib están categorizados en Publindex?</B></summary>
    
<br>
Por el momento, no, pero los artículos de datos sí lo están.
...
---
 ...
 <details>
  <summary markdown="span"><B>Si una etiqueta de un espécimen de colección tiene una letra o número ilegible (por ejemplo, 196?-02-06), ¿Cómo se sugiere documentar el espacio? </B></summary>
    
<br>
El estándar no permite documentación incompelta del año, aunque hay varias posibles soluciones para este inconveniente. Se puede revisar el resto de la información asociada al especímen para intentar recuperar la información. Por ejemplo, si la fecha de la identificación es de 1967, se asume que la colecta se dió en años previos, descartando alguno años de la decada de los 60’. Otra opción es revisar especímenes tomados en la misma salida de campo para tratar de recuperar así el año.<br>
    
Si aún hay dudas se puede usar el campo occurrenceRemarks y anotar que hay incertidumbre sobre la fecha. La fecha original (con el interrogante) se documenta en el elemento verbatimEventData para mayor transparencia en este caso complejo. También se puede documentar un rango de fechas así: 1960-02-06/1969-02-06.
...
---
 ...
 <details>
  <summary markdown="span"><B>¿En el buscador del SiB se enlazan las sinonimias de cada especie?</B></summary>
    
<br>
No. Se recomienda a los usuarios realizar ellos mismos las búsquedas teniendo en cuenta las sinonimias ya que hay datos históricos que, aunque tienen nombres válidos, no son los aceptados en el momento.
...
---
 ...
 <details>
  <summary markdown="span"><B>¿Es posible encontrar diferencias taxonómicas entre las bases de datos SIB y GBIF?</B></summary>
    
<br>
En los datos originales no se encuentran diferencias. Sin embargo, en los datos interpretados sí pueden haber diferencias ya que GBIF homologa todos los taxa a su árbol taxonómico para optimizar la consulta y búsqueda de los datos.
...
---
 ...
 <details>
  <summary markdown="span"><B>¿cuál es el paquete en R que mejor se conecta a GBIF para descarga y exploración de datos?
      </B></summary>
    
<br>
    
Estos dos links se pueden encontrar herramientas útiles recomendadas:
<ul>
    <li><a href="url">https://www.gbif.org/tool/81747/rgbif</a></li>
    <li><a href="url">https://www.gbif.org/tool/82601/biogeo-an-r-package-for-assessing-and-improving-data-quality-of-occurrence-record-datasets</a></li>
    </ul>
