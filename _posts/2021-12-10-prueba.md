...
___
 ...
 <details>
  <summary markdown="span"><B>¿El Estándar Darwin Core permite trabajar con coordenadas geográficas en vez de decimales?</B></summary>
...
<details>
  <summary markdown="span"><B>¿Cómo es la visibilidad de los datos de esecies en en categorías de amenaza, peligro, peligro crítico?</B></summary>
...
<br>
Existen muchas fuentes para corroborar la taxonomía superior o validar los nombres científicos documentados, esto depende del grupo biológico particular y del criterio del taxónomo que realiza las identificaciones. En todo caso, se recomienda usar referentes taxonómicos propios de cada grupo (tales como FishBase, IndexFungorum, Iplant); sin embargo, ningún referente es perfecto y normalmente hay falencias a nivel de especies endémicas. El backbone de GBIF comprende muchos de estos referentes especializados. También se recomienda usar listas de referencia locales o usar bases generales como Global Name Resolver, que integra varias fuentes taxonómicas.
