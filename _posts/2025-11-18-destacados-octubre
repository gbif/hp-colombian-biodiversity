---
preTitle: 18 de noviembre, 2025
title: Páramos, bosques andinos y colecciones científicas: en octubre se fortaleció el conocimiento sobre la biodiversidad colombiana
description: _Durante este mes, fundaciones, empresas y universidades aportaron con registros biológicos, eventos de muestreo y conjunto de datos que fortalecen el conocimiento de nuestra biodiversidad._
date: 2025-11-18
...
En octubre, el [Consejo Comunitario Mayor del Alto San Juan – ASOCASAN](https://www.equatorinitiative.org/2020/04/24/solution11272/){:target="_blank"} se une como **nuevo socio publicador** del SiB Colombia, aportando información clave para la conservación de la biodiversidad en el Pacífico colombiano. Su primera publicación reúne **1707 registros biológicos** de fauna asociados al Banco de Hábitat Alto Río San Juan - Yerrecuy, ubicado entre los municipios de Tadó y Cértegui, en el departamento del Chocó. Los registros documentan especies de mamíferos, aves, reptiles y anfibios, distribuidas en **4 clases, 31 órdenes, 66 familias, 190 géneros y 218 especies.** La información recolectada constituye una línea base fundamental para evaluar el estado actual y futuro del ecosistema, así como los avances en los procesos de preservación y restauración ecológica previstos en el plan de monitoreo del Banco de Hábitat.

Consulta el recurso en: [Caracterización de fauna para el registro del Banco de Hábitat Alto Río San Juan - Yerrecuy](https://biodiversidad.co/data?datasetKey=936228d1-3958-448d-b6ba-8c45956738f8){:target="_blank"}

Así mismo, [SierraCol Energy](https://sierracolenergy.com/){:target="_blank"} se une como nuevo socio publicador a la red de datos sobre biodiversidad del país, aportando su primer conjunto de datos sobre la fauna terrestre del Campo de Producción Cosecha, ubicado en el municipio de Arauquita, Arauca. Esta publicación reúne** 1631 registros biológico**s que documentan la riqueza de anfibios, reptiles, aves y mamíferos presentes en esta zona del oriente colombiano. Este trabajo hace parte de las medidas de seguimiento y monitoreo exigidas por la licencia ambiental del Campo de Producción Cosecha, la cual establece que estas evaluaciones deben realizarse cada cinco años, garantizando así una vigilancia continua del estado de la fauna local. Los resultados permitieron registrar** 17 especies de anfibios, 18 de reptiles, 214 de aves y 20 de mamíferos**, fortaleciendo el conocimiento sobre la biodiversidad en una región clave para los ecosistemas de transición entre la Orinoquia y la Amazonia. Esta información contribuye al seguimiento de las medidas ambientales establecidas para el campo de producción y será de utilidad para futuros procesos de gestión, conservación y monitoreo ecológico.

Consulta el recurso en: [Monitoreo de fauna del Campo de Producción Cosecha, primer semestre de 2025, Arauquita, Arauca](https://biodiversidad.co/data?datasetKey=dba75ea0-cb3e-49f1-b818-0069f507c6e7){:target="_blank"}  \
...
Consulta el recurso en: [Eficacia de la endoterapia con dependencia de la altura de aplicación en relación a las fases lunares en tres especies vegetales: Ficus soatensis, Fraxinus chinensis, Schinus molle](https://biodiversidad.co/data?datasetKey=4a44f20a-d734-4c09-b6d2-4cf469f375b9){:target="_blank"} 
...
Por otra parte, la Colección de Microorganismos Entomopatógenos asociados a la Palma de Aceite (MEAPA)  de [CENIPALMA](https://www.cenipalma.org/){:target="_blank"} presentó este mes una actualización, incorporando** 48 nuevos registros** y alcanzando un total de 193 hongos y nemátodos obtenidos entre 2019 y 2025 en plantaciones de palma de aceite de ocho departamentos del país. Esta colección, fundamental para el desarrollo de estrategias de control biológico en el agroecosistema palmero, reúne microorganismos aislados a partir de insectos colectados mediante muestreo aleatorio simple en municipios con presencia del cultivo. Los datos cuentan con **2 órdenes, 5 familias y 8 géneros **entre los cuales se pudieron identifica**r 5 especies**. La versión más reciente, publicada el 30 de octubre de 2025, es respaldada por el Fondo de Fomento Palmero, fortalece el acceso público a información crítica para la investigación, conservación y manejo sostenible del cultivo, y posiciona a MEAPA como un repositorio especializado clave dentro del **SiB Colombia**.

Puedes consultar la colección en: [Colección de Microorganismos Entomopatógenos Asociados a la Palma de Aceite](https://ipt.biodiversidad.co/sib/resource?r=cenipalma_meapa){:target="_blank"}

Y de regreso a la capital, la Colección Taxonómica Central (CTC) del [Museo Entomológico de la Universidad Nacional de Colombia](https://cienciasagrarias.bogota.unal.edu.co/investigacion-y-extension/museo-de-entomol%C3%B3gico-unab){:target="_blank"}[ ](https://cienciasagrarias.bogota.unal.edu.co/investigacion-y-extension/museo-de-entomol%C3%B3gico-unab)reportó la incorporación de **12 nuevas familias** de artrópodos, alcanzando un total de 49 familias representadas en su acervo. Esta colección, reconocida oficialmente por el Ministerio de Ambiente, Vivienda y Desarrollo Territorial como una de las colecciones de historia natural del país. La CTC, que actualmente reúne **7096 registros biológicos** correspondientes a 395 especies recolectadas entre 1940 y 2024, fortalece su representatividad con esta actualización, ampliando el alcance taxonómico de una de las colecciones entomológicas de referencia en el país.
