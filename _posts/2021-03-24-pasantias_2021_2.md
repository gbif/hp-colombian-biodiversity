...
date:   2021-03-24
categories: ["Pasantías", "Convocatorias", "Instituto Humboldt", "2021"]
background: /assets/images/noticias_eventos/2021/2021-03-24-pasantias_2021_2.jpg
---
...
Si tienes dudas, por favor escríbenos a [sib@humboldt.org.co](sib@humboldt.org.co) con el asunto: “Pasantías 2021-2”.
...
- **Carrerass**: Diseño Gráfico, Diseño Industrial, Diseño interactivo, Artes visuales, Animación.
- **Temáticass**: Divulgación científica, Datos Abiertos, Visualización de Datos.
- **Objetivos**: Diseñar e implementar estrategias de divulgación que apoyen la publicación, acceso y uso de datos abiertos sobre biodiversidad.
- **Actividadess**: Crear, maquetar, preparar, editar y optimizar publicaciones en distintos canales digitales (web y redes sociales) para el Sistema de Información sobre Biodiversidad de Colombia (SiB Colombia).
...
## AC01 - Información de la Biodiversidad - Énfasis en limpieza de datos
...
## AC02 - Información de la Biodiversidad y Gestión Ambiental
...
## AC03 - Información de la Biodiversidad y Datos Marinos
...
- **Objetivo**: Elaborar y curar las fichas de especies publicadas a través del [Catálogo de la biodiversidad de Colombia](http://catalogo.biodiversidad.co/){:target="_blank"} facilitando así la toma de decisiones, investigación y divulgación científica.
- **Actividades**: Apoyar la administración de los contenidos del [Catálogo de la biodiversidad de Colombia](http://catalogo.biodiversidad.co/){:target="_blank"}. Integrar nuevas fichas de especies objetos de conservación. Integrar nuevas fichas de especies de interés del pasante.
