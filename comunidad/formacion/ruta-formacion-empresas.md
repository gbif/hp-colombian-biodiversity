...
### Curso 1 <BR> Empresa y biodiversidad: fundamentos para publicar datos con valor
  ...
  **Módulos**
  ...
  - Módulo 1: ABC de la biodiversidad en Colombia
  - Módulo 2: De dónde vienen y para dónde van los datos
...
Se profundiza en el conocimiento del estándar internacional Darwin Core, mediante la aplicación del mismo en la preparación de conjuntos de datos previa su publicación.
  ...
  **Módulos**
  ...
  - Módulo 1: Usando el estándar, por donde empezar
  - Módulo 2: Manos a la obra: estandarizando observaciones 
...
Las bases de datos geográficas (GDB) combinan información del medio abiótico, como la geológica, la hidrológica o la climática, con el biótico continental y marino. Son una estructura de intercambio de datos común en el sector empresarial. 
  ...
  **Módulos**
  ...
  - Módulo 1: La biodiversidad en una GDB
  - Módulo 2: Transformación de coordenadas
  - Módulo 3: Anatomía de una GDB - Eventos y observaciones
...
### Curso 5 <BR> Datos abiertos y permisos de recolección
  ...
  **Módulos**
  ...
  - Módulo 1: ABC del proceso
  - Módulo 2: Preparación, carga y mapeo
  - Módulo 3: Contexto y metadatos para hacer público el reporte
...
**¿Puedo tomar solo algunos cursos?**
  
  Sí, pero lo ideal es cursar la ruta completa.
