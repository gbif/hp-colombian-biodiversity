...
### 5.2 Ajustar los elementos adicionales siguiendo el estándar _Darwin Core_
...
<div class="notification is-info is-light">
  <b>Nota:</b> Para algunos campos en las tablas de fauna o hidrobiología, puede ser necesario utilizar los dominios en el Diccionario geográfico con el fin de documentar la información. Se recomienda revisar el paso 6 de la guía <b><a href="https://biodiversidad.co/formacion/estructuracion-eventos-bd-geografica#paso-6-creación-de-elementos-obligatorios-y-ajuste-de-elementos-documentados">Estructurando una base de datos geográfica en DwC, eventos</a></b>.
</div>
