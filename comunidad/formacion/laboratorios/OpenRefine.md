...
<span class="tag is-light"><b>.*(?:(?!ae).).$</b></span>_. Esta expresión permite excluir todas las palabras de la columna que no terminan en _<span class="tag is-success is-light"><i>ae</i></span>, las cuales corresponden a las últimas letras de la declinación en latín para la categoría taxonómica de familia (*idae*, *ceae*) (Fig, 15).
