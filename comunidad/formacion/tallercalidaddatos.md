...
3. Para aprovechar al máximo las actividades de este curso, los participantes deben poseer las siguientes habilidades y conocimientos:
    ...
    a. Competencias básicas en el uso de computadores e Internet y, en particular, en el uso de hojas de cálculo.

    b. Conocimientos básicos sobre el estándar [Darwin Core](https://dwc.tdwg.org/){:target="_blank"} y publicación de datos a través de GBIF.

    c. Disposición para difundir el conocimiento aprendido en el taller con otras personas de su entorno profesional o académico, adaptando los materiales de capacitación, manteniendo su valor instructivo.
