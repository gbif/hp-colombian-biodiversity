...
| **Objetivo**    | Crear una lista nacional y páginas de especies para todas las 3.800 especies de peces estimadas en Colombia con información biológica relevante  |
...
| **Objetivo**    |Crear listas de control de las comunidades vegetales y conjuntos de datos de eventos de muestreo en el bosque seco colombiano    |
...
| **Objetivo**    |Movilizar datos biológicos de moscas descomponedoras a través de las plataformas del nodo colombiano y la red de GBIF para brindar información de libre acceso|
...
| **Objetivo**    |Conocer la utilidad, en términos de conservación, de las colecciones de epífitas y sus socios comensalistas    |
