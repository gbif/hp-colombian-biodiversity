...
background: /assets/images/dataton-amazonia/banner-dataton-amazonia-landing.png
height: "41vh"
toc: true
composition:
  - type: heroBox
...
<table>
  <tr>
   ...
   <td style="width: 65%;">
     <p>De las 80.346 especies observadas en Colombia, la Amazonía colombiana aporta 16.991, poco más de la quinta parte. De estas 454 especies son únicas de la región (endémicas).</p>
...
<table style="text-align: center;">
  <tr>
   ...
   <td style="width: 33%;">
     <img src="https://biodiversidad.co/assets/images/landing_page/iconos_cifras/ico_conjuntoDatos_gris.png" width="60" alt="Conjuntos de datos">
   </td>
   <td style="width: 33%;">
